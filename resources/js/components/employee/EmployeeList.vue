                ...
                <div class="modal-body">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="bank_acc_no" name="bank_acc_no" v-model="form.bank_acc_no" placeholder="Bank Account Number"
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="bank_name" name="bank_name" v-model="form.bank_name" placeholder="Bank Name"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="routing_no" name="routing_no" v-model="form.routing_no" placeholder="Routing Number"
