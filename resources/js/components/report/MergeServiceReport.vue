      ...
      axios
          ...
          .then((response) => {
            ...
            if (response.data.status && response.data.serviceMaster) {
                ...
                this.pagination.per_page = serviceMaster.per_page;
                this.pagination.current_page = serviceMaster.current_page;
                this.pagination.from = serviceMaster.from;
                this.pagination.to = serviceMaster.to;

                // Optional: show the pagination text "1 - 10 of 103"
                this.paginationText = `${serviceMaster.from} - ${serviceMaster.to} of ${serviceMaster.total}`;
            } else {
