          ...
          <div class="table-section" ref="document">
            <data-table :columns="columns" :sortKey="sortKey" :sortOrders="sortOrders" @sort="sortBy" id="printMe">
              ...
              <tr v-for="(providedService, index) in providedServiceList" :key="providedService.ServiceMasterID" :class="{'row-even': index % 2 === 0, 'row-odd': index % 2 !== 0}">
                ...
                <td class="td-cost">
                  <div class="cost-cell">
                    <span class="cost-value">{{ providedService.SelfTotalCost || 0 }}</span>
        ...
        <div class="modal-content modern-modal">
          <div class="modal-header modern-modal-header">
            <div class="modal-title-wrap">
              ...
              <h5 class="modal-title" id="totalCostModalLabel">Update Total Cost</h5>
            </div>
...
export default {
  ...
  methods: {
    ...
    openTotalCostModal(service) {
      ...
      this.editTotalCost.totalCost = service.SelfTotalCost || 0;
      $('#totalCostModal').modal('show');
    },
    updateTotalCost() {
      this.updating = true;
      axios.post(this.base_url + '/api/admindashboard/updateSelfServiceTotalCost', {
